      ...
      <div className="mx-auto max-w-6xl overflow-hidden rounded-3xl bg-gradient-to-b from-rose-900 to-rose-800 shadow-lg">
        <div className="px-6 py-14 sm:px-10">
          <div className="mx-auto max-w-2xl text-center">
            <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-white/15 text-2xl font-bold text-rose-100">
              ★
            </div>
            ...
            <div className="mt-8 flex justify-center">
              <Link
                href="/register"
                className="inline-flex items-center justify-center rounded-xl bg-white px-6 py-3 text-sm font-semibold text-rose-700 hover:bg-rose-50"
              >
                Register Your Business <span aria-hidden className="ml-2">→</span>
              </Link>
            </div>

            <div className="mt-10 grid gap-3 text-sm text-white/90 sm:grid-cols-3">
